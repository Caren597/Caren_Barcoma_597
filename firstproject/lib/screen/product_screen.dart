...
import 'package:firstproject/utils/product_controller.dart';
...
@override
  ...
  void addProduct(int id) async{
   if(nameController.text.isEmpty || priceController.text.isEmpty || quantityController.text.isEmpty){return;}
